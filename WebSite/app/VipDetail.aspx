<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VipDetail.aspx.cs" Inherits="app_VipDetail" %>
...
<body>
    ...
    <div class="container">
        <div class="page detail-page tabbar js_show">
            ...
            <div class="page__ft">
                <div class="cart-col"  style="display:none;">
                ...
                <div class="btn-col" style="padding-bottom:.4rem;">
                    <button id="btnAddToCart" style="display:none;" class="weui-btn weui-btn_mini weui-btn_plain-primary">加入购物车</button>
