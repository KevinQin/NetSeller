<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Friend.aspx.cs" Inherits="app_Friend" %>
   ...
   <form id="form1" runat="server"></form>
    <div class="container">
        <div class="page uc-page js_show">
            <div class="page__bd" style="height:100%;background-color:#fff;" >
                <div class="weui-tab">
                    <div class="weui-tab__panel">
                        <div class="panel_f_hd">                         
                        </div>
                    </div>
                </div>
         </div>
